...
void AAuraEffectActor::ApplyEffectToTarget(AActor* TargetActor, TSubclassOf<UGameplayEffect> GameplayEffectClass)
{
	...
	if (bIsInfinite && InfiniteEffectEffectRemovalPolicy == EEffectRemovalPolicy::RemoveOnEndOverlap)
	{
...
void AAuraEffectActor::OnOverlap(AActor* TargetActor)
{
	...
	if (DurationEffectEffectApplicationPolicy == EEffectApplicationPolicy::ApplyOnOverlap)
	{
		ApplyEffectToTarget(TargetActor, DurationGameplayEffectClass);
	}

	if (InfiniteEffectEffectApplicationPolicy == EEffectApplicationPolicy::ApplyOnOverlap)
	{
...
void AAuraEffectActor::OnEndOverlap(AActor* TargetActor)
{
	...
	if (DurationEffectEffectApplicationPolicy == EEffectApplicationPolicy::ApplyOnEndOverlap)
	{
		ApplyEffectToTarget(TargetActor, DurationGameplayEffectClass);
	}

	if (InfiniteEffectEffectApplicationPolicy == EEffectApplicationPolicy::ApplyOnEndOverlap)
	{
		ApplyEffectToTarget(TargetActor, InfiniteGameplayEffectClass);
	}

	if (InfiniteEffectEffectRemovalPolicy == EEffectRemovalPolicy::RemoveOnEndOverlap)
	{
		UAbilitySystemComponent* TargetAbilitySystemComponent = UAbilitySystemBlueprintLibrary::GetAbilitySystemComponent(TargetActor);
